#!/bin/zsh
# ytdl_setup.sh
# Plex Trailer Pipeline - Shell Function Installer
# Adds ytdl, ytdl1080, and ytdl1440 functions to ~/.zprofile
...
ytdl() {
  ...
  local output="${latest/_temp.mkv/.mkv}"
...
echo ""
echo "Output will be saved to ~/Movies as a Plex-compatible H.264 MKV file."
